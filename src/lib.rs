...
mod tests {
    ...
    fn test_initialize_mint_success() {
        ...
        let (mint_key, mut mint, mint_meta) = _generate_account(4242424242, Mint::get_packed_len(), false);
        let (account_key, mut account, account_meta) = _generate_account(4242424242, Account::get_packed_len(), false);
        let (owner_key, mut owner, owner_meta) = _generate_account(4242424242, Account::get_packed_len(), false);
        ...
        _init_mint(&program_id, account_infos.as_mut());
    }
